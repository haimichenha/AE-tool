...
$log='C:\Users\Public\Documents\MediaCore_cleanup.log'
try {
  ...
  $env:PYTHONUTF8='1'
  & 'C:\Python313\python.exe' (Join-Path $PSScriptRoot '.mediacore_conservative_cleanup.py') --apply *>&1 | Out-File -LiteralPath $log -Append -Encoding utf8
