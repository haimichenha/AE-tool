# AE localization materials

This folder groups the retained source-only materials by integration target. The scripts may reference local paths from the original lab environment; review and adapt paths before use.
