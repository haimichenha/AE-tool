...
$log='C:\Users\Public\Documents\AE_stability_restore.log'
try {
  ...
  $env:PYTHONUTF8='1'
  & 'C:\Python313\python.exe' (Join-Path $PSScriptRoot '.restore_stability_baseline.py') --apply *>&1 | Out-File -LiteralPath $log -Append -Encoding utf8
